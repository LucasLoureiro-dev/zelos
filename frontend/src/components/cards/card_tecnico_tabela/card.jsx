...
export default function Card_dashboard_usuario_table({ cargo, id }) {
    ...
    useEffect(() => {
        if (cargo) {
            fetch(`http://localhost:8080/pool/tipo/${cargo}`, {
                credentials: 'include'
            })
                .then((response) => {
                    if (response.ok) {
                                                ...
                                                <div className="modal-body">
                                                    ...
                                                    <div className="row">
                                                        {modal.estado == 'em andamento' || modal.estado == 'concluida' ? (
                                                            <h1>Chamado concluido/ em andamento</h1>
                                                        ) : (
                                                            <>
                                                                <h5>
                                                                    Sem técnicos ainda
                                                                </h5>
                                                                    <button type='button' onClick={handleSubmit} className="btn  botao-vermelhao d-flex justify-content-center w-25 fw-bold">
                                                                        Se atribuir
                                                                    </button>
                                                            </>
                                                        )}
